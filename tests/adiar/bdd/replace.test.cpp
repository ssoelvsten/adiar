    ...
    */
    ...
    describe("bdd_replace(const bdd&, <...>, replace_type)", [&]() {
      ...
      describe("<shift>", [&]() {
        ...
        it("shifts variables in 'BDD 1' multiple times [+2, -1]", [&]() {
          const bdd out = bdd_replace(bdd_replace(bdd_1, [](const int x) { return x + 2; }, replace_type::Shift),
                                      [](const int x) { return x - 1; }, replace_type::Shift);
    ...
    describe("bdd_replace(const bdd&, <...>)", [&]() {
      ...
      describe("<shift>", [&]() {
        it("shifts variables in 'BDD 2'", [&]() {
          int m_calls = 0;
          const mapping_type m = [&](const int x) { m_calls++; return x + 2; };
          const bdd out        = bdd_replace(bdd_2, m);
        ...
        it("identifies 2x+1 as a mere shift for 'x0'", [&]() {
          int m_calls = 0;
          const mapping_type m = [&](const int x) { m_calls++; return 2 * x + 1; };
        ...
        it("identifies 4-x as a mere shift on 'x0'", [&]() {
          int m_calls = 0;
          const mapping_type m = [&m_calls](const int x) { m_calls++; return 4 - x; };
          const bdd out        = bdd_replace(bdd_x0, m);
    ...
    describe("bdd_replace(__bdd&&, <...>, replace_type)", [&]() {
      ...
      describe("<shift>", [&]() {
        ...
        it("reduces and shifts variables [__bdd_x0_unreduced]", [&]() {
          ...
          const bdd out = bdd_replace(__bdd(__bdd_x0_unreduced, exec_policy()), m, replace_type::Shift);
      ...
      describe("<identity>", [&]() {
        ...
        it("reduces 'x0' [__bdd_x0_unreduced]", [&]() {
          ...
          const bdd out = bdd_replace(__bdd(__bdd_x0_unreduced, exec_policy()), m, replace_type::Identity);
    ...
    describe("bdd_replace(__bdd&&, <...>)", [&]() {
      ...
      describe("<monotone>", [&]() {
        it("squares variables in ~'BDD 5'", [&]() {
          ...
          // n4
          AssertThat(out_nodes.can_pull(), Is().True());
          AssertThat(out_nodes.pull(), Is().EqualTo(node(9, bdd::max_id - 2, terminal_T, terminal_F)));
          ...
          AssertThat(out_nodes.pull(),
                     Is().EqualTo(node(1,
                                       bdd::max_id - 1,
                                       terminal_T,
                                       bdd::pointer_type(9, bdd::max_id - 2))));
      ...
      describe("<shift>", [&]() {
        ...
        it("reduces and shifts +42 variables [__bdd_3_unreduced]", [&]() {
          ...
          AssertThat(
            out_nodes.pull(),
            Is().EqualTo(node(43, bdd::max_id - 1, terminal_F, bdd::pointer_type(44, bdd::max_id))));
      ...
      describe("<identity>", [&]() {
        it("returns the original file on reduced 'x0'", [&]() {
          int m_calls          = 0;
          const mapping_type m = [&](const int x) { m_calls++; return x; };
          const bdd out        = bdd_replace(exec_policy(), __bdd(bdd_x0_nf), m);
