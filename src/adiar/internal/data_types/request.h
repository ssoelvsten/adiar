...
namespace adiar::internal
{
  ...
  ///
  /// \tparam Cardinality   The cardinality of the algorithm, e.g. it is 1 for `bdd_restrict`, 2 for
  ///                       `bdd_apply` and 3 for `bdd_ite`.
  ///
  /// \tparam NodeCarrySize Number of children being forwarded with the request. This is used when
  ...
  public:
    ...
    ///
    /// \details This is not implemented as a `std::array<children_type, node_carry_size>` because
    /// for `node_carry_size` being 0 we still spend 8 bytes on empty space.
    ///
    /// \see NO_CHILDREN
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Whether the node carry is empty. That is, this is a faster way to compute whether
    ///        `nodes_carried() == 0`.
    ///
  ...
  public:
    ...
    /// \param t  Target of the request
    ///
    /// \param nc List of the children that already have been visited but needs to be forwarded to
    ///           fully resolve the request to `t`.
    ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /// \brief Extension of the request struct to carry extra data. That data can also impact the
  ///        ordering.
  ///
  /// \see request
  ...
  public:
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Whether the parent pointer should be part of resolving sorting two requests.
    ///
    /// \details Currently, this is only true in debug mode, since we do not need it for correctness
    ///          but only for predictability of the order of the output.
    ////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef NDEBUG
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Comparator to break ties based on the source.
    ////////////////////////////////////////////////////////////////////////////////////////////////
    inline bool
