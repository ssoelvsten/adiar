...
namespace adiar::internal
{
  ...
  ///
  /// \tparam value_t     The type of elements within the tuple. This part should have a partial
  ///                     ordering '<'.
  ///
  /// \tparam cardinality The number of elements in the tuple (default: `2`)
  ///
  /// \tparam is_sorted   Whether elements are given in sorted order (default: `false`).
  //////////////////////////////////////////////////////////////////////////////////////////////////
