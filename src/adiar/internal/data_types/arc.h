...
namespace adiar::internal
{
  ...
  ///
  /// \details An arc contains a value for the source and one for the target. Notice, that we don't
  ///          specifically have a member for is_high. The reason for this choice is that the C++
  ///          compiler makes everything word-aligned. That means with an explicit is_high member it
  ///          would take up 3 x 64 bits rather than only 2 x 64 bits.
  ///
  /// \remark If `source` is flagged, then this is a high arc rather than a low arc.
  ///
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Type of variable level.
    ////////////////////////////////////////////////////////////////////////////////////////////////
    using level_type = pointer_type::level_type;

    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Type able to hold the level of a variable.
    ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    ///
    /// \pre The flags on both `source` and `target` are already set correctly and the out-index on
    ///      `source` is too.
    ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Obtain the outdegree index, i.e. the child number this arc is of the `source` node.
    ////////////////////////////////////////////////////////////////////////////////////////////////
