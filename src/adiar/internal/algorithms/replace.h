  ...
  */
  ...
  namespace __replace {
    ...
    public:
      ...
      ///          are then treated as target levels "in-between".
      //////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //       vary whether it is the *before* or the *after* level which gets a +1.
    template<typename Policy>
    ...
    public:
      ...
      pq_levels(const T&) const
      {
        ...
        const generator<level_type> after_gen =
      ...
      map_level(const level_type& x)
      {
        ...
        if (this->is_jump_target(x)) { return unshifted_level; }
    ...
    using jdown_pq1_type =
      levelized_node_priority_queue<jdown_request<0>,
    ...
    jdown__ilevel_upper_bound(const In& in)
    {
      ...
      // TODO: Multiply by 2 to take into account the edges can be swapped?
      return to_size(internal_true * internal_false + false_only * true_only + ConstSizeInc);
    }
             ...
             const size_t pq2_max_size)
    {
      ...
      PriorityQueue_1 pq1(policy.template pq_levels<PriorityQueue_1>(dd), pq1_memory, pq1_max_size, stats_replace.lpq);
      // TODO: Root request!
             ...
             const size_t pq2_bound)
    {
      ...
      const size_t pq_1_memory_fits =
        jdown_pq1_type<ADIAR_LPQ_LOOKAHEAD, memory_mode::Internal>::memory_fits(pq_1_internal_memory);
      ...
      if (!external_only && max_pq_1_size <= no_lookahead_bound(2)) {
        ...
        return jdown_pq<Policy, PriorityQueue_1, PriorityQueue_2>(ep, dd, m, pq_1_internal_memory, max_pq_1_size, pq_2_internal_memory, max_pq_2_size);
        ...
        return jdown_pq<Policy, PriorityQueue_1, PriorityQueue_2>(ep, dd, m, pq_1_memory, max_pq_1_size, pq_2_memory, max_pq_2_size);
      }
    }
