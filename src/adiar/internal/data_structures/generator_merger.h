#ifndef ADIAR_INTERNAL_DATA_STRUCTURES_GENERATOR_MERGER_H
#define ADIAR_INTERNAL_DATA_STRUCTURES_GENERATOR_MERGER_H
...
namespace adiar::internal
{
  ...
  private:
    ...
    public:
      level_info_istream(const dd& diagram)
        : _ifstream(diagram)
      {}

      level_info_istream(const __dd& diagram)
        : _ifstream(diagram)
      {}
  ...
  public:
    ...
    public:
      ...
      istream_ptr(const dd& diagram)
        : _ptr(make_unique<level_info_istream>(diagram))
      {}
      ...
      istream_ptr(const Generator &gen)
        : _ptr(make_unique<generator_istream>([=]() -> optional<value_type> {
              const auto x = gen();
  ...
  public:
    ...
    pull()
    {
      ...
      for (istream_ptr& p : this->_istream_ptrs) {
        if (p->can_pull() && level_of(p->peek()) == min_level) {
          p->pull();
        }
      }
      return min_level;
